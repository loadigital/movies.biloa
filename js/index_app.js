...
menu.innerHTML = `
		...
		<li><a href="https://loadigital.github.io/movies.biloa/pluto.html"><i class="bi-p-circle icon"></i> Pluto TV</a></li>
                </ul>
...
co_menu_lateral.innerHTML = `
		...
		<div class="bc-1"><a target="_blank" href="https://mdstrm.com/live-stream/574463697b9817cf0886fc17?enablejsapi=1&autoplay=true&muted=1&starttime=0"><i class="bi-display icon"></i>Caracol TV</a></div>
  		<div class="bc-1"><a href="https://loadigital.github.io/movies.biloa/pluto.html"><i class="bi-p-circle icon"></i>Pluto TV</a></div>
                <hr>
