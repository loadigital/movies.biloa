...
const fetchData = async () => {
    try{
        const res = await fetch('https://loadigital.github.io/movies.biloa/js/api_db_series.json');
...
const filtrar = ()=>{
    ...
    if(nombre.indexOf(texto) !== -1){
        ...
        <div class="co-cards">
        <div class="cards">
         <div class="img-cards"><a href="${producto.posterLink.link_web}"><img src="${producto.imgLink}" alt=""></a></div>
